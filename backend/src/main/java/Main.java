            ...
            while (true) {
                ...
                if (httpMethod.equals("POST") && requestUrl.equals("/validateUser")) {
                    if (jsonObject != null) {
                        ...
                        boolean validationPassed = valid.validateName(jsonObject.get("name").getAsString())
                                && valid.validateNumber(jsonObject.get("phone").getAsString())
                                && valid.validateEmail(jsonObject.get("email").getAsString());
